...
import fr.unice.polytech.si5.al.creditrama.teamd.clientservice.model.CardRequest;
...
public interface BankAccountClient {
    ...
    BankAccount addCard(@PathVariable("iban") String iban, @RequestBody CardRequest card);
}